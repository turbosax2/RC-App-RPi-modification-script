...
Change tty1 to tty3: ```console=tty3```  
...
TTYVTDisallocate=no
ExecStart=
ExecStart=-/sbin/agetty --noclear --skip-login --nonewline --noissue --autologin <username> --noclear %I $TERM*
```
...
**nano ~/.xinitrc**  
Add this before the xllvnc line: ```feh --fullscreen --hide-pointer --auto-zoom /home/<username>/splash.png &```  
...
Input section, comment out: ```%(name)s = probesysfs```  
Add: ```waveshare = hidinput,/dev/input/event1```  
...
**sudo nano /boot/firmware/cmdline.txt**  
Add to end: ```video=HDMI-A-1:1600x600@60D```  
...
chmod +x /home/<username>/chromatek_led.py
```  
...
[Service]
ExecStart=/usr/bin/python3 /home/<username>/chromatek_led.py
Restart=always
User=root
Type=simple
KillSignal=SIGTERM
